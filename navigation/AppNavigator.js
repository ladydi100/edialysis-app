...
import HealthValuesPage from '../pages/HealthValuesPage';
    ...
    <Stack.Navigator>
      {userToken ? (
        <>
          ...
          {/* Flujo de Salud */}
          <Stack.Screen name="HealthPage" component={HealthValuesPage} />
          <Stack.Screen name="HealthValuesPage" component={HealthValuesPage} />
          <Stack.Screen name="HealthTrackingPage" component={HealthTrackingPage} />
